...
for i in node_list:
    ...
    #Check this section #####################################################################
        ...
        integrand_c0 = (-N_1_i_min1_x[element_1_num_pts:] /delta_h) * (1) /delta_h - N_1_i_min1[element_1_num_pts:] * N_2_i_min1[:element_1_num_pts - 1]
        integrand_c1 = (-N_2_i_min1_x[:element_1_num_pts] /delta_h) * (1) /delta_h - N_2_i_min1[:element_1_num_pts] * N_2_i_min1[:element_1_num_pts]
        integrand_c2 = (-N_1_i_x[element_2_num_pts:] /delta_h ) * (-1) /delta_h - N_1_i[element_2_num_pts:] * N_1_i[element_2_num_pts:]
        integrand_c3 = (-N_2_i_x[:element_2_num_pts] /delta_h ) * (-1) /delta_h - N_2_i[:element_2_num_pts] * N_1_i[element_2_num_pts + 1:]
...
e = np.e *np.ones(len(x_distribution))
y_true = -e/(-e**2-1) * e**x_true + e/(-e**2-1)*e**(-x_true)
...
plt.title("30 node FEM solution of u_xx - u = 0")
plt.xlabel("x")
plt.ylabel("u")

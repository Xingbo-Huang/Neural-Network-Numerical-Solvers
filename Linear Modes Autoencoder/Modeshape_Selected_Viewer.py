...
ax3.plot(t, Q_data[:, 0], color = "blue", label = "Selected Modal Response 1")
# ax3.plot(t, Q_data[:, 1], color = "red", label = "Selected Modal Response 2")
# ax3.plot(t, Q_data[:, 2], color = "orange", label = "Selected Modal Response 3")
